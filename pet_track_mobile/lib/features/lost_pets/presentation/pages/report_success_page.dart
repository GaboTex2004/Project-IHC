                ...
                children: [
                  ...
                  Text(
                    formData.reportType == ReportType.lost
                        ? 'Tu mascota perdida ha sido registrada en el sistema'
                        : 'El animal ha sido registrado en el sistema',
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        const Text(
          'Pendientes de integración con el servidor',
          style: TextStyle(fontSize: 11, color: AppColors.textMuted),
        ),
      ],
    );
